...
class TAMERMixedPolicy(SACPolicy):
    """
    Policy class (with actor, critic, and human critic) for TAMER.
...
MlpMixedPolicy = TAMERMixedPolicy

class TAMERHumanPolicy(BasePolicy):
    """
    Policy class (with both actor and human critic) for TAMER.
...
MlpHumanPolicy = TAMERHumanPolicy
